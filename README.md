...
'aliases' => [
              //...
              '@Hwg' => '@vendor/Yii-Utils/widget/hwgNav', // or path/extracted/to
              //...
2-
'module' => [
             //...
...
<header>
    <?php 
		echo Hwg\hwgNavBar::widget(['id' => preg_replace('/[^a-z]+/','',Yii::$app->homeUrl),
...
<main role="main" class="flex-shrink-0">
	<div class="row gx-0">
		<div class="col-10 col-sm-3">
			<?php
				echo Hwg\hwgNavBar::widget(['id' => 'AaZzzz',
						'brandLabel' => Yii::$app->name,
						'brandUrl' => Yii::$app->homeUrl,
...
#### C- Thêm cột trong table menu: mysql full table:
